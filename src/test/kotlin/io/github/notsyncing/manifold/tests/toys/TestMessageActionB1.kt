...
class TestMessageActionB1 : ManifoldAction<String, ManifoldEvent?, Any, ManifoldRunnerContext>(false, true, String::class.java) {
    ...
    init {
        node = ManifoldEventBus.register("test.msg.action.B1", "group2")
