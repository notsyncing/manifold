...
class ManifoldRunner(val trans: ManifoldTransaction<*>? = null, var context: ManifoldRunnerContext? = null) {
    operator fun <A: ManifoldAction<*, R, F, C>, R, F, C: ManifoldRunnerContext> invoke(c: Class<A>): F {
    ...
    operator fun <A: ManifoldAction<*, R, F, C>, R, F, C: ManifoldRunnerContext> invoke(c: Class<A>, f: (A) -> CompletableFuture<R>): CompletableFuture<R> {
